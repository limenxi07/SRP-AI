...
from pythae.samplers.base import BaseSampler
from pythae.samplers.normal_sampling import NormalSamplerConfig
...
class NormalSampler(BaseSampler):
    ...
    def sample(
        ...
        if last_batch_samples_nbr > 0:
            ...
            x_gen = self.model.decoder(z)["reconstruction"].detach() # ERROR
