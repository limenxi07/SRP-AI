...
class TrainingConfig:
    ...
    output_dir = "diffusion-healthy-2"  # the model name locally and on the HF Hub
...
# DATASET & PROCESSING
dataset = load_dataset('imagefolder', data_dir='../images/G_square_healthy_2')['train']
...
def evaluate(config, epoch, pipeline):
    ...
    # Save the images
    test_dir = '../results/diffusion_results_2'
